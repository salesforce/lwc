...
- `@lwc/integration-wtr`: primary client-side LWC test suite, using Web Test Runner
- `@lwc/integration-wdio`: WebDriverIO tests, used for anything WTR can't do, such as user agent gestures such as changing focus
