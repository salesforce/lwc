...
CMD_UPDATE_TAGS="lerna exec --ignore perf-benchmarks --ignore integration-tests -- npm dist-tag add \$LERNA_PACKAGE_NAME@${LWC_VERSION} ${TAG_NAME} --registry='https://npm.lwcjs.org'"
