...
describe('Node.getRootNode on patched elements', () => {
    ...
    const selectors: any = {};
    selectors.xChild = (elm) => getHostShadowRoot(elm)!.querySelector('x-child');
    selectors.xChildSpanInShadow = (elm) => getHostShadowRoot(selectors.xChild(elm))!.querySelector('.child-cmp-span');
    selectors.containerDiv = (elm) => getHostShadowRoot(elm)!.querySelector('.child-div');
    selectors.containerSlottedSpan = (elm) => getHostShadowRoot(elm)!.querySelector('.child-cmp-slotted-span');
    ...
    describe('when options.composed=false', () => {
        ...
        it('should return itself as root when node is a shadow', () => {
            ...
            return Promise.resolve().then(() => {
                expect(getHostShadowRoot(elm).getRootNode()).toBe(getHostShadowRoot(elm));
            });
        });
        ...
        it('should containing shadow of an element in the template of a component', () => {
            ...
            return Promise.resolve().then(() => {
                ...
                expect(childDiv!.getRootNode()).toBe(getHostShadowRoot(elm));
            });
        });
        ...
        it('should containing shadow when node is a component custom element', () => {
            ...
            return Promise.resolve().then(() => {
                ...
                expect(childCmp.getRootNode()).toBe(getHostShadowRoot(elm));
            });
        });
        ...
        it('should return containing shadow when the node is in a component hierachy', () => {
            ...
            return Promise.resolve().then(() => {
                ...
                expect(spanInChildCmp!.getRootNode()).toBe(getHostShadowRoot(selectors.xChild(elm)));
            });
        });
        ...
        it('should return containing shadow when node is inside a slot', () => {
            ...
            return Promise.resolve().then(() => {
                ...
                expect(spanInChildCmp!.getRootNode()).toBe(getHostShadowRoot(elm));
            });
        });
    });
});
