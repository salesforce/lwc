...
const ELEMENT_NODE = 1, TEXT_NODE = 3, COMMENT_NODE = 8, DOCUMENT_FRAGMENT_NODE = 11;
...
const hooks: Array<keyof LifeCycleHooks> = ['create', 'update', 'remove', 'destroy', 'pre', 'post'];

export function init(modules: Array<Partial<Module>>, api: DOMAPI,
                     compareFn?: (vnode1: VNode, vnode2: VNode) => boolean): PatchFunction {
