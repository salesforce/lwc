import { VNodes, VText } from "../3rdparty/snabbdom/types";
...
const FromIteration: WeakMap<VNodes | VText, 1> = new WeakMap();

// dynamic children means it was generated by an iteration
// in a template, and will require a more complex diffing algo.
export function markAsDynamicChildren(children: VNodes | VText) {
    FromIteration.set(children, 1);
}

export function hasDynamicChildren(children: VNodes | VText): boolean {
