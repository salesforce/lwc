...
import { create, seal, ArrayPush, isFunction, ArrayIndexOf, isUndefined, StringIndexOf, hasOwnProperty, defineProperty, getOwnPropertyDescriptor, getOwnPropertyNames, ArrayReduce, getPrototypeOf } from "./language";
