...
describe('ReactiveMembrane', () => {
    describe('#getReactiveProxy()', () => {
        it('should throw for non-object values', () => {
            ...
            expect(() => membrane.getReactiveProxy(undefined)).toThrow();
            expect(() => membrane.getReactiveProxy("")).toThrow();
            expect(() => membrane.getReactiveProxy(NaN)).toThrow();
            expect(() => membrane.getReactiveProxy(function() {})).toThrow();
            expect(() => membrane.getReactiveProxy(1)).toThrow();
        });
        ...
        it.only('should not throw an exception when object proxy is frozen and property is accessed', function() {
            const target = new ReactiveMembrane({
                propertyMemberChange: () => {},
                propertyMemberAccess: () => {},
            });
