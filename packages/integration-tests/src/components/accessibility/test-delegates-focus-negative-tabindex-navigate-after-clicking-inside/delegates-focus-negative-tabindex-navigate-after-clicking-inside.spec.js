...
const URL =
    'http://localhost:4567/delegates-focus-negative-tabindex-navigate-after-clicking-inside';
...
describe('When delegatesFocus=true and tabindex=-1, and navigating with the keyboard', () => {
    ...
    it.skip('should skip forwards', function() {
        ...
        var className = browser.execute(function() {
            return document.activeElement.shadowRoot.activeElement.className; // container // input
        }).value;
    ...
    it.skip('should navigate forwards inside shadow once shadow is clicked into', function() {
        ...
        var className = browser.execute(function() {
            return document
                .activeElement.shadowRoot.activeElement.shadowRoot.activeElement.className; // container // integration-child // input
        }).value;
