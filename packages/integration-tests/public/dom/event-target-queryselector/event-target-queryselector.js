(function (lwc) {
  ...
  __setKey(tmpl$1, "stylesheetTokens", {
    hostAttribute: "integration-event-target-queryselector_event-target-queryselector-host",
    shadowAttribute: "integration-event-target-queryselector_event-target-queryselector"
  });
  ...
  var element = lwc.createElement('integration-event-target-queryselector', {
    is: Cmp,
    fallback: fallback
  });
