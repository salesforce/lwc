(function (lwc) {
  ...
  function tmpl$1($api, $cmp, $slotset, $ctx) {
    ...
    return [api_custom_element("integration-child", _integrationChild, {
      ...
      key: 4
    }, [api_dynamic($cmp._ES5ProxyType ? $cmp.get("childTextContent") : $cmp.childTextContent)])];
  }
  ...
  __setKey(tmpl$1, "stylesheetTokens", {
    hostAttribute: "integration-element-textcontent_element-textcontent-host",
    shadowAttribute: "integration-element-textcontent_element-textcontent"
  });
  ...
  function (_LightningElement) {
    ...
    function App() {
      ...
      __setKey(_this, "childTextContent", void 0);
    ...
    _createClass(App, [{
      ...
      value: function renderedCallback() {
        var _this$template$queryS, _textContent;

        __setKey(this, "childTextContent", (_this$template$queryS = __callKey1(this._ES5ProxyType ? this.get("template") : this.template, "querySelector", 'integration-child'), _textContent = _this$template$queryS._ES5ProxyType ? _this$template$queryS.get("textContent") : _this$template$queryS.textContent));
      }
    }]);
  ...
  var element = lwc.createElement('integration-element-textcontent', {
    is: Cmp,
    fallback: fallback
  });
