(function (lwc) {
  ...
  function tmpl$1($api, $cmp, $slotset, $ctx) {
    ...
    return [api_element("div", {
      ...
      key: 2
    }, [api_dynamic($cmp._ES5ProxyType ? $cmp.get("text") : $cmp.text)])];
  }
  ...
  function (_LightningElement) {
    ...
    _createClass(Child, [{
      key: "foo",
      value: function foo() {
        __setKey(this, "text", 'method executed successfully');
      }
    }]);
  ...
  function tmpl$2($api, $cmp, $slotset, $ctx) {
    ...
    }, [api_text("Click me")]), api_custom_element("integration-child", _integrationChild, {
      key: 3
    }, [])];
  }
  ...
  function (_LightningElement) {
    ...
    function App() {
      ...
      return _possibleConstructorReturn(this, __callKey2(_getPrototypeOf(App), "apply", this, arguments));
    }
  ...
  function tmpl$3($api, $cmp, $slotset, $ctx) {
    ...
    return [api_custom_element("test-case", _testCase, {
      props: {
        "playgroundId": "SkIjbPYjZ/6",
        "issueTitle": "Accessing element methods via querySelector throws",
        "issueId": "653"
      },
      key: 2
  ...
  __setKey(tmpl$3, "stylesheetTokens", {
    hostAttribute: "integration-queryselector-child-method_queryselector-child-method-host",
    shadowAttribute: "integration-queryselector-child-method_queryselector-child-method"
  });

  var Issue653 =
  /*#__PURE__*/
  function (_LightningElement) {
    _inherits(Issue653, _LightningElement);

    function Issue653() {
      _classCallCheck(this, Issue653);

      return _possibleConstructorReturn(this, __callKey2(_getPrototypeOf(Issue653), "apply", this, arguments));
    }

    return Issue653;
  }(lwc.LightningElement);

  var Cmp = lwc.registerComponent(Issue653, {
    tmpl: _tmpl$3
  });

  var fallback = __callKey1(location._ES5ProxyType ? location.get("search") : location.search, "indexOf", 'nativeShadow=true') !== -1 ? false : true;
  var element = lwc.createElement('integration-queryselector-child-method', {
    is: Cmp,
    fallback: fallback
  });
