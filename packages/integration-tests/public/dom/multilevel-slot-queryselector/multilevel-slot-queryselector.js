(function (lwc) {
  ...
  function (_LightningElement) {
    ...
    _createClass(Child, [{
      ...
      value: function select(sel) {
        return __callKey1(this, "querySelector", sel);
      }
    }]);
  ...
  __setKey(tmpl$3, "stylesheetTokens", {
    hostAttribute: "integration-multilevel-slot-queryselector_multilevel-slot-queryselector-host",
    shadowAttribute: "integration-multilevel-slot-queryselector_multilevel-slot-queryselector"
  });
  ...
  var element = lwc.createElement('integration-multilevel-slot-queryselector', {
    is: Cmp,
    fallback: fallback
  });
