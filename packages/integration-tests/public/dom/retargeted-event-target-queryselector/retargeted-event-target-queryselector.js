(function (lwc) {
  ...
  __setKey(tmpl$1, "stylesheetTokens", {
    hostAttribute: "integration-retargeted-event-target-queryselector_retargeted-event-target-queryselector-host",
    shadowAttribute: "integration-retargeted-event-target-queryselector_retargeted-event-target-queryselector"
  });
  ...
  function (_LightningElement) {
    ...
    _createClass(LightdomQuerySelector, [{
      ...
      value: function handleClick(evt) {
        var div = __callKey1(evt._ES5ProxyType ? evt.get("currentTarget") : evt.currentTarget, "querySelector", 'div');

        __callKey2(div, "setAttribute", 'data-selected', 'true');
      }
    }]);
  ...
  var element = lwc.createElement('integration-retargeted-event-target-queryselector', {
    is: Cmp,
    fallback: fallback
  });
