(function (lwc) {
  ...
  function tmpl$1($api, $cmp, $slotset, $ctx) {
    ...
    return [api_custom_element("integration-child", _integrationChild, {
      ...
      key: 4
    }, [api_dynamic($cmp._ES5ProxyType ? $cmp.get("childOuterHTML") : $cmp.childOuterHTML)])];
  }
  ...
  __setKey(tmpl$1, "stylesheetTokens", {
    hostAttribute: "integration-element-outerhtml_element-outerhtml-host",
    shadowAttribute: "integration-element-outerhtml_element-outerhtml"
  });
  ...
  function (_LightningElement) {
    ...
    function App() {
      ...
      __setKey(_this, "childOuterHTML", void 0);
    ...
    _createClass(App, [{
      ...
      value: function renderedCallback() {
        var _this$template$queryS, _outerHTML;

        __setKey(this, "childOuterHTML", (_this$template$queryS = __callKey1(this._ES5ProxyType ? this.get("template") : this.template, "querySelector", 'integration-child'), _outerHTML = _this$template$queryS._ES5ProxyType ? _this$template$queryS.get("outerHTML") : _this$template$queryS.outerHTML));
      }
    }]);
  ...
  var element = lwc.createElement('integration-element-outerhtml', {
    is: Cmp,
    fallback: fallback
  });
