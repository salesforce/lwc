(function (lwc) {
  ...
  function tmpl($api, $cmp, $slotset, $ctx) {
    var _state, _sections, _id_01Bxx000002990XEA, _collapsed;
    ...
    return [api_text("Result: "), api_element("span", {
      ...
      key: 2
    }, [api_dynamic((_state = $cmp._ES5ProxyType ? $cmp.get("state") : $cmp.state, _sections = _state._ES5ProxyType ? _state.get("sections") : _state.sections, _id_01Bxx000002990XEA = _sections._ES5ProxyType ? _sections.get("id_01Bxx000002990XEAQ") : _sections.id_01Bxx000002990XEAQ, _collapsed = _id_01Bxx000002990XEA._ES5ProxyType ? _id_01Bxx000002990XEA.get("collapsed") : _id_01Bxx000002990XEA.collapsed))])];
  }
  ...
  __setKey(tmpl, "stylesheetTokens", {
    hostAttribute: "integration-nested-state_nested-state-host",
    shadowAttribute: "integration-nested-state_nested-state"
  });
  ...
  var element = lwc.createElement('integration-nested-state', {
    is: Cmp,
    fallback: fallback
  });
