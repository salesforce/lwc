(function (lwc) {
  ...
  __setKey(tmpl$1, "stylesheetTokens", {
    hostAttribute: "integration-delegates-focus-tab-index-zero-no-focusable-elements-no-after-elements_delegates-focus-tab-index-zero-no-focusable-elements-no-after-elements-host",
    shadowAttribute: "integration-delegates-focus-tab-index-zero-no-focusable-elements-no-after-elements_delegates-focus-tab-index-zero-no-focusable-elements-no-after-elements"
  });
  ...
  var Cmp = lwc.registerComponent(Parent, {
    tmpl: _tmpl$1
  });

  var fallback = __callKey1(location._ES5ProxyType ? location.get("search") : location.search, "indexOf", 'nativeShadow=true') !== -1 ? false : true;
  var element = lwc.createElement('integration-delegates-focus-tab-index-zero-no-focusable-elements-no-after-elements', {
    is: Cmp,
    fallback: fallback
  });
