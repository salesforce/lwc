(function (lwc) {
  ...
  function tmpl$1($api, $cmp, $slotset, $ctx) {
    ...
    return [api_element("a", {
      ...
      key: 2
    }, [api_text("Anchor 1")]), api_element("a", {
      attrs: {
        "href": "#"
      },
      key: 3
    }, [api_text("Anchor 2")]), api_custom_element("integration-child", _integrationChild, {
      props: {
        "tabIndex": "-1"
      },
      key: 4
  ...
  __setKey(tmpl$1, "stylesheetTokens", {
    hostAttribute: "integration-delegate-focus-tab-into-disabled-button-after-negative-tabindex_delegate-focus-tab-into-disabled-button-after-negative-tabindex-host",
    shadowAttribute: "integration-delegate-focus-tab-into-disabled-button-after-negative-tabindex_delegate-focus-tab-into-disabled-button-after-negative-tabindex"
  });
  ...
  var element = lwc.createElement('integration-delegate-focus-tab-into-disabled-button-after-negative-tabindex', {
    is: Cmp,
    fallback: fallback
  });
