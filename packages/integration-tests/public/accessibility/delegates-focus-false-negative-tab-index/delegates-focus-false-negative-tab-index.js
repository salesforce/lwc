(function (lwc) {
  ...
  function tmpl($api, $cmp, $slotset, $ctx) {
    ...
    return [api_element("span", {
      ...
      key: 2
    }, [api_text("Inside child")]), api_element("input", {
      attrs: {
        "type": "text"
      },
      key: 3
  ...
  __setKey(tmpl$1, "stylesheetTokens", {
    hostAttribute: "integration-delegates-focus-false-negative-tab-index_delegates-focus-false-negative-tab-index-host",
    shadowAttribute: "integration-delegates-focus-false-negative-tab-index_delegates-focus-false-negative-tab-index"
  });
