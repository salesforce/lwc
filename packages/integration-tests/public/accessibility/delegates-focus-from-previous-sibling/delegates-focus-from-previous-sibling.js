(function (lwc) {
  ...
  __setKey(tmpl$1, "stylesheetTokens", {
    hostAttribute: "integration-delegates-focus-from-previous-sibling_delegates-focus-from-previous-sibling-host",
    shadowAttribute: "integration-delegates-focus-from-previous-sibling_delegates-focus-from-previous-sibling"
  });
  ...
  var element = lwc.createElement('integration-delegates-focus-from-previous-sibling', {
    is: Cmp,
    fallback: fallback
  });
