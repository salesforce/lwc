(function (lwc) {
  ...
  function tmpl$1($api, $cmp, $slotset, $ctx) {
    ...
    }, []), ($cmp._ES5ProxyType ? $cmp.get("focusInCalled") : $cmp.focusInCalled) ? api_element("div", {
      classMap: {
        "focus-in-called": true
      },
      key: 3
    }, [api_text("Focus in called")]) : null];
  }
  ...
  __setKey(tmpl$1, "stylesheetTokens", {
    hostAttribute: "integration-delegates-focus-negative-tabindex-focusin-handler_delegates-focus-negative-tabindex-focusin-handler-host",
    shadowAttribute: "integration-delegates-focus-negative-tabindex-focusin-handler_delegates-focus-negative-tabindex-focusin-handler"
  });
  ...
  function (_LightningElement) {
    ...
    function Test() {
      ...
      _this = _possibleConstructorReturn(this, __callKey2((_getPrototypeOf3 = _getPrototypeOf2 = _getPrototypeOf(Test), _call = _getPrototypeOf3._ES5ProxyType ? _getPrototypeOf3.get("call") : _getPrototypeOf3.call), "apply", _getPrototypeOf2, __concat([this], args)));
