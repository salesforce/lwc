(function (lwc) {
  ...
  __setKey(tmpl$1, "stylesheetTokens", {
    hostAttribute: "integration-delegate-focus-tab-into-negative-tabindex-from-location-bar_delegate-focus-tab-into-negative-tabindex-from-location-bar-host",
    shadowAttribute: "integration-delegate-focus-tab-into-negative-tabindex-from-location-bar_delegate-focus-tab-into-negative-tabindex-from-location-bar"
  });
  ...
  var element = lwc.createElement('integration-delegate-focus-tab-into-negative-tabindex-from-location-bar', {
    is: Cmp,
    fallback: fallback
  });
