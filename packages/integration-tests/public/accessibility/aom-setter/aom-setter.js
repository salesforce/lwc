(function (lwc) {
  ...
  function tmpl($api, $cmp, $slotset, $ctx) {
    ...
    return [api_element("div", {
      ...
      key: 2
    }, [api_dynamic($cmp._ES5ProxyType ? $cmp.get("internalLabel") : $cmp.internalLabel)])];
  }
  ...
  function (_LightningElement) {
    ...
    function Child() {
      ...
      __setKey(_this, "internalLabel", void 0);
    ...
    _createClass(Child, [{
      key: "ariaLabel",
      get: function get() {
        return this._ES5ProxyType ? this.get("internalLabel") : this.internalLabel;
      },
      set: function set(value) {
        __setKey(this, "internalLabel", value);
      }
    }]);
  ...
  __setKey(tmpl$1, "stylesheetTokens", {
    hostAttribute: "integration-aom-setter_aom-setter-host",
    shadowAttribute: "integration-aom-setter_aom-setter"
  });

  var AomSetter =
  /*#__PURE__*/
  function (_LightningElement) {
    _inherits(AomSetter, _LightningElement);

    function AomSetter() {
      _classCallCheck(this, AomSetter);

      return _possibleConstructorReturn(this, __callKey2(_getPrototypeOf(AomSetter), "apply", this, arguments));
    }

    return AomSetter;
  }(lwc.LightningElement);

  var Cmp = lwc.registerComponent(AomSetter, {
    tmpl: _tmpl$1
  });

  var fallback = __callKey1(location._ES5ProxyType ? location.get("search") : location.search, "indexOf", 'nativeShadow=true') !== -1 ? false : true;
  var element = lwc.createElement('integration-aom-setter', {
    is: Cmp,
    fallback: fallback
  });
