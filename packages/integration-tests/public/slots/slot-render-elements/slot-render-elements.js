(function (lwc) {
  ...
  __setKey(tmpl$1, "slots", ["secret-slot"]);
  ...
  function tmpl$2($api, $cmp, $slotset, $ctx) {
    ...
    return [api_custom_element("integration-child", _integrationChild, {
      ...
      classMap: {
        "content-in-slot": true
      },
      attrs: {
        "slot": "secret-slot"
      },
      key: 3
    }, [api_text("Content rendered in slot")])])];
  }
  ...
  function tmpl$3($api, $cmp, $slotset, $ctx) {
    ...
    return [api_custom_element("test-case", _testCase, {
      props: {
        "playgroundId": "rkAOfTTqb/2",
        "issueId": "627",
        "issueTitle": "Named slot doesn't work properly."
      },
      key: 2
  ...
  __setKey(tmpl$3, "stylesheetTokens", {
    hostAttribute: "integration-slot-render-elements_slot-render-elements-host",
    shadowAttribute: "integration-slot-render-elements_slot-render-elements"
  });

  var SlotRenderElements =
  /*#__PURE__*/
  function (_LightningElement) {
    _inherits(SlotRenderElements, _LightningElement);

    function SlotRenderElements() {
      _classCallCheck(this, SlotRenderElements);

      return _possibleConstructorReturn(this, __callKey2(_getPrototypeOf(SlotRenderElements), "apply", this, arguments));
    }

    return SlotRenderElements;
  }(lwc.LightningElement);

  var Cmp = lwc.registerComponent(SlotRenderElements, {
    tmpl: _tmpl$3
  });

  var fallback = __callKey1(location._ES5ProxyType ? location.get("search") : location.search, "indexOf", 'nativeShadow=true') !== -1 ? false : true;
  var element = lwc.createElement('integration-slot-render-elements', {
    is: Cmp,
    fallback: fallback
  });
