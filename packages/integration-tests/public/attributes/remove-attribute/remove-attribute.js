(function (lwc) {
  ...
  function (_LightningElement) {
    ...
    _createClass(Child, [{
      ...
      value: function connectedCallback() {
        __callKey1(this, "removeAttribute", 'title');
      }
    }]);
  ...
  __setKey(tmpl$1, "stylesheetTokens", {
    hostAttribute: "integration-remove-attribute_remove-attribute-host",
    shadowAttribute: "integration-remove-attribute_remove-attribute"
  });

  var RemoveAttribute =
  /*#__PURE__*/
  function (_LightningElement) {
    _inherits(RemoveAttribute, _LightningElement);

    function RemoveAttribute() {
      _classCallCheck(this, RemoveAttribute);

      return _possibleConstructorReturn(this, __callKey2(_getPrototypeOf(RemoveAttribute), "apply", this, arguments));
    }

    return RemoveAttribute;
  }(lwc.LightningElement);

  var Cmp = lwc.registerComponent(RemoveAttribute, {
    tmpl: _tmpl$1
  });

  var fallback = __callKey1(location._ES5ProxyType ? location.get("search") : location.search, "indexOf", 'nativeShadow=true') !== -1 ? false : true;
  var element = lwc.createElement('integration-remove-attribute', {
    is: Cmp,
    fallback: fallback
  });
