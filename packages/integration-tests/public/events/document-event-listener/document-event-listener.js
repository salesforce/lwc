(function (lwc) {
  ...
  function tmpl($api, $cmp, $slotset, $ctx) {
    ...
    return [api_element("button", {
      ...
      classMap: {
        "document-event-target-tagname": true
      },
      key: 3
    }, [api_dynamic($cmp._ES5ProxyType ? $cmp.get("documentEventTargetTagName") : $cmp.documentEventTargetTagName)])];
  }
  ...
  __setKey(tmpl, "stylesheetTokens", {
    hostAttribute: "integration-document-event-listener_document-event-listener-host",
    shadowAttribute: "integration-document-event-listener_document-event-listener"
  });
  ...
  function (_LightningElement) {
    ...
    function WindowEventListener() {
      ...
      __setKey(_this, "documentEventTargetTagName", '');
    ...
    _createClass(WindowEventListener, [{
      ...
      value: function connectedCallback() {
        ...
        __callKey2(document, "addEventListener", 'click', function (evt) {
          var _target, _tagName;

          __setKey(_this2, "documentEventTargetTagName", __callKey0((_target = evt._ES5ProxyType ? evt.get("target") : evt.target, _tagName = _target._ES5ProxyType ? _target.get("tagName") : _target.tagName), "toLowerCase"));
        });
      }
    }, {
      key: "handleClick",
  ...
  var element = lwc.createElement('integration-document-event-listener', {
    is: Cmp,
    fallback: fallback
  });
