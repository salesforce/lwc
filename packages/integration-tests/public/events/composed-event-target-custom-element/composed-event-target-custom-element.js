(function (lwc) {
  ...
  function (_LightningElement) {
    ...
    _createClass(Child, [{
      ...
      value: function dispatchFoo() {
        __callKey1(this, "dispatchEvent", new CustomEvent('foo', {
          composed: true,
          bubbles: true
        }));
      }
  ...
  __setKey(tmpl$1, "stylesheetTokens", {
    hostAttribute: "integration-composed-event-target-custom-element_composed-event-target-custom-element-host",
    shadowAttribute: "integration-composed-event-target-custom-element_composed-event-target-custom-element"
  });
  ...
  var element = lwc.createElement('integration-composed-event-target-custom-element', {
    is: Cmp,
    fallback: fallback
  });
