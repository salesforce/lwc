(function (lwc) {
  ...
  function tmpl($api, $cmp, $slotset, $ctx) {
    ...
    }, [api_text("Child")]), ($cmp._ES5ProxyType ? $cmp.get("defaultPrevented") : $cmp.defaultPrevented) ? api_element("div", {
      classMap: {
        "default-prevented-indicator": true
      },
      key: 3
    }, [api_text("Default Prevented")]) : null];
  }
  ...
  function (_LightningElement) {
    ...
    function Child() {
      ...
      __setKey(_this, "defaultPrevented", false);
    ...
    _createClass(Child, [{
      ...
      value: function handleClick() {
        ...
        __setKey(this, "defaultPrevented", event._ES5ProxyType ? event.get("defaultPrevented") : event.defaultPrevented);
      }
    }]);
  ...
  __setKey(tmpl$1, "stylesheetTokens", {
    hostAttribute: "integration-default-prevented_default-prevented-host",
    shadowAttribute: "integration-default-prevented_default-prevented"
  });

  var DefaultPrevented =
  /*#__PURE__*/
  function (_LightningElement) {
    _inherits(DefaultPrevented, _LightningElement);

    function DefaultPrevented() {
      _classCallCheck(this, DefaultPrevented);

      return _possibleConstructorReturn(this, __callKey2(_getPrototypeOf(DefaultPrevented), "apply", this, arguments));
    }

    _createClass(DefaultPrevented, [{
      key: "handleFoo",
      value: function handleFoo(evt) {
        __callKey0(evt, "preventDefault");
      }
    }]);
  ...
  var Cmp = lwc.registerComponent(DefaultPrevented, {
    tmpl: _tmpl$1
  });

  var fallback = __callKey1(location._ES5ProxyType ? location.get("search") : location.search, "indexOf", 'nativeShadow=true') !== -1 ? false : true;
  var element = lwc.createElement('integration-default-prevented', {
    is: Cmp,
    fallback: fallback
  });
