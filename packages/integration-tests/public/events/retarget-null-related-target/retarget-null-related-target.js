(function (lwc) {
  ...
  function tmpl($api, $cmp, $slotset, $ctx) {
    ...
    return [($cmp._ES5ProxyType ? $cmp.get("relatedTargetIsNull") : $cmp.relatedTargetIsNull) ? api_element("span", {
      classMap: {
        "related-target-tabname": true
      },
      key: 2
    }, [api_text("Related target is null")]) : null, api_element("input", {
      classMap: {
        "focus-input": true
      },
      attrs: {
      ...
      key: 3,
      on: {
        "focus": _m0 || __setKey($ctx, "_m0", api_bind($cmp._ES5ProxyType ? $cmp.get("handleFocusIn") : $cmp.handleFocusIn))
      }
    }, [])];
  }
  ...
  __setKey(tmpl, "stylesheetTokens", {
    hostAttribute: "integration-retarget-null-related-target_retarget-null-related-target-host",
    shadowAttribute: "integration-retarget-null-related-target_retarget-null-related-target"
  });
  ...
  function (_LightningElement) {
    ...
    function RetargetRelatedTarget() {
      ...
      _this = _possibleConstructorReturn(this, __callKey2((_getPrototypeOf3 = _getPrototypeOf2 = _getPrototypeOf(RetargetRelatedTarget), _call = _getPrototypeOf3._ES5ProxyType ? _getPrototypeOf3.get("call") : _getPrototypeOf3.call), "apply", _getPrototypeOf2, __concat([this], args)));
