(function (lwc) {
  ...
  function tmpl$1($api, $cmp, $slotset, $ctx) {
    ...
    return [api_custom_element("integration-child", _integrationChild, {
      ...
      key: 4
    }, [api_text("First")]), api_element("option", {
      attrs: {
        "value": "2"
      },
      key: 5
    }, [api_text("Second")])])]), ($cmp._ES5ProxyType ? $cmp.get("targetIsSelect") : $cmp.targetIsSelect) ? api_element("div", {
      classMap: {
        "target-is-select": true
      },
      key: 7
    }, [api_text("Event Target is select element")]) : null];
  }
  ...
  __setKey(tmpl$1, "stylesheetTokens", {
    hostAttribute: "integration-slotted-event-target_slotted-event-target-host",
    shadowAttribute: "integration-slotted-event-target_slotted-event-target"
  });

  var SlottedEventTarget =
  /*#__PURE__*/
  function (_LightningElement) {
    ...
    function SlottedEventTarget() {
      ...
      _this = _possibleConstructorReturn(this, __callKey2((_getPrototypeOf3 = _getPrototypeOf2 = _getPrototypeOf(SlottedEventTarget), _call = _getPrototypeOf3._ES5ProxyType ? _getPrototypeOf3.get("call") : _getPrototypeOf3.call), "apply", _getPrototypeOf2, __concat([this], args)));
    ...
    _createClass(SlottedEventTarget, [{
      ...
      value: function handleChange(evt) {
        ...
        __setKey(this, "targetIsSelect", __callKey0((_target = evt._ES5ProxyType ? evt.get("target") : evt.target, _tagName = _target._ES5ProxyType ? _target.get("tagName") : _target.tagName), "toLowerCase") === 'select');
      }
    }]);
