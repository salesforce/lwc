...
import { HOST_ATTRIBUTE, MACRO_ATTRIBUTE, SHADOW_ATTRIBUTE } from './utils/selectors-scoping';
...
export default function serialize(result: Result, config: Config): string {
    ...
    if (serializedStyle) {
        // inline function
        buffer += `function stylesheet(${HOST_SELECTOR_IDENTIFIER}, ${SHADOW_SELECTOR_IDENTIFIER}, ${SHADOW_DOM_ENABLED_IDENTIFIER}, ${MACRO_SELECTOR_IDENTIFIER}) {\n`;
