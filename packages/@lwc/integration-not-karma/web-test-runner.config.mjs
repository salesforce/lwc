...
export default {
    files: [
        ...
        '!test/shadow-dom/Element-properties/Element.innerHTML.spec.js',
        ...
        '!test/template/directive-lwc-dom-manual/index.spec.js',
