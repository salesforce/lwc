(function (lwc) {
  ...
  function tmpl($api, $cmp, $slotset, $ctx) {
    ...
    }, [api_text("Trigger custom focusin")]), ($cmp._ES5ProxyType ? $cmp.get("eventIsComposed") : $cmp.eventIsComposed) ? api_element("div", stc2, [api_text("Focus In Composed")]) : null, ($cmp._ES5ProxyType ? $cmp.get("customEventNotComposed") : $cmp.customEventNotComposed) ? api_element("div", stc3, [api_text("Custom Focus In Not Composed")]) : null];
  ...
  var FocusInComposedTrue = /*#__PURE__*/function (_LightningElement) {
    _inherits(FocusInComposedTrue, _LightningElement);

    var _super = _createSuper(FocusInComposedTrue);
