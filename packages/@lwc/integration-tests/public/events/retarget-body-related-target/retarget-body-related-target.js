(function (lwc) {
  ...
  function tmpl($api, $cmp, $slotset, $ctx) {
    ...
    return [api_element("span", stc0, [api_text(api_dynamic_text($cmp._ES5ProxyType ? $cmp.get("relatedTargetTagName") : $cmp.relatedTargetTagName))]), api_element("input", {
      classMap: stc1,
      key: 1,
      on: {
  ...
  var RetargetBodyRelatedTarget = /*#__PURE__*/function (_LightningElement) {
    _inherits(RetargetBodyRelatedTarget, _LightningElement);

    var _super = _createSuper(RetargetBodyRelatedTarget);
