(function (lwc) {
  ...
  function tmpl($api, $cmp, $slotset, $ctx) {
    ...
    }), ($cmp._ES5ProxyType ? $cmp.get("notComposed") : $cmp.notComposed) ? api_element("div", stc1, [api_text("Not Composed")]) : null];
  ...
  var ChangeEventComposed = /*#__PURE__*/function (_LightningElement) {
    _inherits(ChangeEventComposed, _LightningElement);

    var _super = _createSuper(ChangeEventComposed);
