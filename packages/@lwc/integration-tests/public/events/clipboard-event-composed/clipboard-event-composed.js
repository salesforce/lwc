(function (lwc) {
  ...
  function tmpl($api, $cmp, $slotset, $ctx) {
    ...
    return [api_custom_element("integration-child", _integrationChild, {
      key: 0,
      on: {
        "copy": _m0 || __setKey($ctx, "_m0", api_bind($cmp._ES5ProxyType ? $cmp.get("handleCopy") : $cmp.handleCopy)),
        "cut": _m1 || __setKey($ctx, "_m1", api_bind($cmp._ES5ProxyType ? $cmp.get("handleCut") : $cmp.handleCut)),
        "paste": _m2 || __setKey($ctx, "_m2", api_bind($cmp._ES5ProxyType ? $cmp.get("handlePaste") : $cmp.handlePaste))
      }
    })];
    /*LWC compiler v2.11.8*/
  }
  ...
  var Container = /*#__PURE__*/function (_LightningElement) {
    ...
    _createClass(Container, [{
      key: "didHandleCopy",
      value: function didHandleCopy() {
        return (this._ES5ProxyType ? this.get("_didHandleCopy") : this._didHandleCopy) || false;
      }
    }, {
      key: "didHandleCut",
      value: function didHandleCut() {
        return (this._ES5ProxyType ? this.get("_didHandleCut") : this._didHandleCut) || false;
      }
    }, {
      key: "didHandlePaste",
      value: function didHandlePaste() {
        return (this._ES5ProxyType ? this.get("_didHandlePaste") : this._didHandlePaste) || false;
      }
    }, {
      key: "handleCopy",
      value: function handleCopy() {
        __setKey(this, "_didHandleCopy", true);
      }
    }, {
      key: "handleCut",
      value: function handleCut() {
        __setKey(this, "_didHandleCut", true);
      }
    }, {
      key: "handlePaste",
      value: function handlePaste() {
        __setKey(this, "_didHandlePaste", true);
      }
      /*LWC compiler v2.11.8*/
