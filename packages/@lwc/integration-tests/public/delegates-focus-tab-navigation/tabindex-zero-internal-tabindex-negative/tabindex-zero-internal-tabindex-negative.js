(function (lwc) {
  ...
  function tmpl$2($api, $cmp, $slotset, $ctx) {
    ...
    return [api_element("button", stc0$2, [api_text("child button (should never be tabbed to)")])];
  ...
  function tmpl$1($api, $cmp, $slotset, $ctx) {
    var api_custom_element = $api._ES5ProxyType ? $api.get("c") : $api.c,
        api_element = $api._ES5ProxyType ? $api.get("h") : $api.h;
    return [api_custom_element("integration-child", _integrationChild, stc0$1), api_element("input", stc1$1), api_custom_element("integration-child", _integrationChild, stc2$1)];
    /*LWC compiler v2.11.8*/
  }
  ...
  function tmpl($api, $cmp, $slotset, $ctx) {
    ...
    return [api_element("input", stc0), api_custom_element("integration-parent", _integrationParent, stc1), api_element("input", stc2)];
    /*LWC compiler v2.11.8*/
  }
