(function (lwc) {
  ...
  function tmpl($api, $cmp, $slotset, $ctx) {
    ...
    return [api_element("input", stc0), api_element("input", stc1), api_element("div", stc2, [api_custom_element("integration-child", _integrationChild, stc3), api_custom_element("integration-child", _integrationChild, stc4), api_custom_element("integration-child", _integrationChild, stc5), api_custom_element("integration-child", _integrationChild, stc6), api_custom_element("integration-child", _integrationChild, stc7)]), api_element("input", stc8), api_element("input", stc9)];
    /*LWC compiler v2.11.8*/
  }
  ...
  var element = lwc.createElement('integration-tabindex-negative', {
    is: Cmp
  });
