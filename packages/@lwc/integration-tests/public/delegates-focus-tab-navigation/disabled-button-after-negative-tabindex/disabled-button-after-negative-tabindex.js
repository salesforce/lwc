(function (lwc) {
  ...
  function tmpl($api, $cmp, $slotset, $ctx) {
    ...
    return [api_element("input", stc0), api_element("input", stc1), api_custom_element("integration-child", _integrationChild, stc2), api_element("button", stc3, [api_text("Disabled button")])];
    /*LWC compiler v2.11.8*/
  }
