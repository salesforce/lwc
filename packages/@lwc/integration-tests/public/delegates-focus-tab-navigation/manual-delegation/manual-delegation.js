(function (lwc) {
  ...
  function tmpl$1($api, $cmp, $slotset, $ctx) {
    var api_tab_index = $api._ES5ProxyType ? $api.get("ti") : $api.ti,
  ...
  var Child = /*#__PURE__*/function (_LightningElement) {
    ...
    _createClass(Child, [{
      key: "tabIndex",
      get: function get() {
        return this._ES5ProxyType ? this.get("privateTabIndex") : this.privateTabIndex;
      }
      /*LWC compiler v2.11.8*/
      ,
      set: function set(value) {
        __setKey(this, "privateTabIndex", value);
      }
    }]);
  ...
  function tmpl($api, $cmp, $slotset, $ctx) {
    ...
    }, [api_text("toggle (current tabindex value: " + api_dynamic_text($cmp._ES5ProxyType ? $cmp.get("privateTabIndex") : $cmp.privateTabIndex) + ")")]), api_element("input", stc0), api_element("input", stc1), api_element("div", stc2, [api_custom_element("integration-child", _integrationChild, {
      classMap: stc3,
      props: {
        "tabIndex": api_tab_index($cmp._ES5ProxyType ? $cmp.get("privateTabIndex") : $cmp.privateTabIndex)
      },
      key: 4
    })]), api_element("input", stc4), api_element("input", stc5)];
    /*LWC compiler v2.11.8*/
  }
  ...
  var Container = /*#__PURE__*/function (_LightningElement) {
    ...
    function Container() {
      ...
      __setKey(_this, "privateTabIndex", 0);
    ...
    _createClass(Container, [{
      ...
      value: function handleClick() {
        __setKey(this, "privateTabIndex", (this._ES5ProxyType ? this.get("privateTabIndex") : this.privateTabIndex) === 0 ? -1 : 0);
      }
      /*LWC compiler v2.11.8*/
