(function (lwc) {
  ...
  function tmpl$1($api, $cmp, $slotset, $ctx) {
    ...
    return [api_element("span", stc0$1, [api_text("Non-tabbable text")]), api_element("input", stc1$1), api_element("span", stc2$1, [api_text("Non-tabbable text")])];
  ...
  var DelegatesFocusTabIndexZero = /*#__PURE__*/function (_LightningElement) {
    _inherits(DelegatesFocusTabIndexZero, _LightningElement);

    var _super = _createSuper(DelegatesFocusTabIndexZero);
