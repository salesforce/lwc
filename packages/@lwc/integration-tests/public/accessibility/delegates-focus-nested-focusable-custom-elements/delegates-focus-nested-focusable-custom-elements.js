(function (lwc) {
  ...
  function stylesheet(token, useActualHostSelector, useNativeDirPseudoclass) {
    var hostSelector = token ? "[" + token + "-host]" : "";
    return useActualHostSelector ? ":host {border: 1px solid red;padding: 10px;}" : hostSelector + " {border: 1px solid red;padding: 10px;}";
    /*LWC compiler v2.11.8*/
  }
  ...
  function tmpl$2($api, $cmp, $slotset, $ctx) {
    ...
    return [api_element("span", stc0$2, [api_text("No focusable content")])];
    /*LWC compiler v2.11.8*/
  }
  ...
  if (_implicitStylesheets) {
    __callKey2((tmpl$2._ES5ProxyType ? tmpl$2.get("stylesheets") : tmpl$2.stylesheets).push, "apply", tmpl$2._ES5ProxyType ? tmpl$2.get("stylesheets") : tmpl$2.stylesheets, _implicitStylesheets);
  }

  if (_implicitStylesheets || _implicitScopedStylesheets) {
    __setKey(tmpl$2, "stylesheetToken", "integration-child_child");
  }
  ...
  function tmpl$1($api, $cmp, $slotset, $ctx) {
    ...
    return [api_element("span", stc0$1, [api_text("Focusable span")]), api_custom_element("integration-child", _integrationChild, stc1$1)];
    /*LWC compiler v2.11.8*/
  }
  ...
  if (_implicitStylesheets$1) {
    __callKey2((tmpl$1._ES5ProxyType ? tmpl$1.get("stylesheets") : tmpl$1.stylesheets).push, "apply", tmpl$1._ES5ProxyType ? tmpl$1.get("stylesheets") : tmpl$1.stylesheets, _implicitStylesheets$1);
  }

  if (_implicitStylesheets$1 || _implicitScopedStylesheets$1) {
    __setKey(tmpl$1, "stylesheetToken", "integration-parent_parent");
  }
  ...
  function tmpl($api, $cmp, $slotset, $ctx) {
    var api_text = $api._ES5ProxyType ? $api.get("t") : $api.t,
        api_element = $api._ES5ProxyType ? $api.get("h") : $api.h,
        api_custom_element = $api._ES5ProxyType ? $api.get("c") : $api.c;
    return [api_element("span", stc0, [api_text("Not focusable")]), api_custom_element("integration-parent", _integrationParent, stc1)];
    /*LWC compiler v2.11.8*/
  }
