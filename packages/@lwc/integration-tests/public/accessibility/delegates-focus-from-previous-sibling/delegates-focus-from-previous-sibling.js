(function (lwc) {
  ...
  function tmpl$1($api, $cmp, $slotset, $ctx) {
    ...
    return [api_element("input", stc0$1), api_element("span", stc1$1, [api_text("Span")])];
  ...
  function tmpl($api, $cmp, $slotset, $ctx) {
    var api_element = $api._ES5ProxyType ? $api.get("h") : $api.h,
        ...
        api_text = $api._ES5ProxyType ? $api.get("t") : $api.t;
    return [api_element("input", stc0), api_custom_element("integration-child", _integrationChild, stc1), api_element("a", stc2, [api_text("Anchor")])];
    /*LWC compiler v2.11.8*/
  }
