(function (lwc) {
  ...
  function tmpl$1($api, $cmp, $slotset, $ctx) {
    ...
    return [api_element("span", stc0$1, [api_text("Focusable span")]), api_element("input", stc1$1), api_element("span", stc2$1, [api_text("Focusable span")])];
  ...
  var DelegatesFocus$1 = /*#__PURE__*/function (_LightningElement) {
    _inherits(DelegatesFocus, _LightningElement);

    var _super = _createSuper$1(DelegatesFocus);
  ...
  var _integrationChild = lwc.registerComponent(DelegatesFocus$1, {
    tmpl: _tmpl$1
  });
