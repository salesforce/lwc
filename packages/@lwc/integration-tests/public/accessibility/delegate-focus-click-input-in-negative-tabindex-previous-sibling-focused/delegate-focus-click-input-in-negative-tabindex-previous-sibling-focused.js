(function (lwc) {
  ...
  function tmpl($api, $cmp, $slotset, $ctx) {
    ...
    return [api_element("a", stc0, [api_text("Anchor 1")]), api_element("a", stc1, [api_text("Anchor 2")]), api_custom_element("integration-child", _integrationChild, stc2), api_element("span", stc3, [api_text("Focusable span")])];
    /*LWC compiler v2.11.8*/
  }
  ...
  var element = lwc.createElement('integration-delegate-focus-click-input-in-negative-tabindex-previous-sibling-focused', {
    is: Cmp
  });
