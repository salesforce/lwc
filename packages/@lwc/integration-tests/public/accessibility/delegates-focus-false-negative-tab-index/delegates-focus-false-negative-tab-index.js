(function (lwc) {
  ...
  function tmpl$1($api, $cmp, $slotset, $ctx) {
    ...
    return [api_element("span", stc0$1, [api_text("Inside child")]), api_element("input", stc1$1), api_element("span", stc2$1, [api_text("Inside child")])];
  ...
  function tmpl($api, $cmp, $slotset, $ctx) {
    ...
    return [api_element("a", stc0, [api_text("First Anchor")]), api_custom_element("integration-child", _integrationChild, stc1), api_element("a", stc2, [api_text("Second Anchor")])];
    /*LWC compiler v2.11.8*/
  }
