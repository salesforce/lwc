(function (lwc) {
  ...
  function tmpl($api, $cmp, $slotset, $ctx) {
    ...
    return [api_element("button", stc0, [api_text("first button")]), api_custom_element("integration-child", _integrationChild, stc1), api_element("button", stc2, [api_text("second button")])];
    /*LWC compiler v2.11.8*/
  }
  ...
  var element = lwc.createElement('integration-delegates-focus-tab-index-zero-no-focusable-elements', {
    is: Cmp
  });
