(function (lwc) {
  ...
  function tmpl$1($api, $cmp, $slotset, $ctx) {
    ...
    return [api_element("button", stc0$1, [api_text("click me")])];
  ...
  function tmpl($api, $cmp, $slotset, $ctx) {
    ...
    return [api_element("input", stc0), api_custom_element("integration-button", _integrationButton, stc1), api_custom_element("integration-button", _integrationButton, stc2), api_custom_element("integration-button", _integrationButton, stc3)];
    /*LWC compiler v2.11.8*/
  }
