(function (lwc) {
  ...
  function tmpl($api, $cmp, $slotset, $ctx) {
    ...
    return [api_element("span", stc0, [api_text("Tabbable span")]), api_element("br", stc1), api_custom_element("integration-child", _integrationChild, stc2), api_element("button", stc3, [api_text("Invisible Button")])];
    /*LWC compiler v2.11.8*/
  }
  ...
  if (_implicitStylesheets || _implicitScopedStylesheets) {
    __setKey(tmpl, "stylesheetToken", "integration-delegates-focus-next-sibling-visibility-false_delegates-focus-next-sibling-visibility-false");
  }
  ...
  var Cmp = /*#__PURE__*/function (_LightningElement) {
