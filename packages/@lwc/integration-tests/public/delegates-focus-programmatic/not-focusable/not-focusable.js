(function (lwc) {
  ...
  function tmpl$1($api, $cmp, $slotset, $ctx) {
    ...
    return [api_element("p", stc0$1, [api_text("Nothing focusable in here!")])];
  ...
  function tmpl($api, $cmp, $slotset, $ctx) {
    ...
    return [api_element("input", stc0), api_custom_element("integration-child", _integrationChild, stc1)];
    /*LWC compiler v2.11.8*/
  }
