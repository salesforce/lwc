(function (lwc) {
  ...
  function tmpl$1($api, $cmp, $slotset, $ctx) {
    ...
    return [api_slot("", stc0$1, stc1$1, $slotset), api_element("input", stc2$1)];
  ...
  function tmpl($api, $cmp, $slotset, $ctx) {
    ...
    return [api_element("input", stc0), api_custom_element("integration-child", _integrationChild, stc1, [api_element("input", stc2)]), api_element("input", stc3)];
    /*LWC compiler v2.11.8*/
  }
