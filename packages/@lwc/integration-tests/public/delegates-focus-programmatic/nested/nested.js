(function (lwc) {
  ...
  function tmpl($api, $cmp, $slotset, $ctx) {
    ...
    }, [api_text("focus")]), api_custom_element("integration-parent", _integrationParent, stc0)];
    /*LWC compiler v2.11.8*/
  }
  ...
  var Container = /*#__PURE__*/function (_LightningElement) {
    ...
    _createClass(Container, [{
      ...
      value: function handleClick() {
        __callKey0(__callKey1(this._ES5ProxyType ? this.get("template") : this.template, "querySelector", 'integration-parent'), "focus");
      }
      /*LWC compiler v2.11.8*/
