...
export interface VM<N = HostNode, E = HostElement> {
    ...
    component: BaseLightningElement;
     ...
     *  Locker only. */
    setHook: (cmp: BaseLightningElement, prop: PropertyKey, newValue: any) => void;
    /** Hook invoked whenever a property is set on the host element. This hook is used by Locker
     *  only. */
    getHook: (cmp: BaseLightningElement, prop: PropertyKey) => any;
    ...
    callHook: (
        cmp: BaseLightningElement | undefined,
        fn: (...args: any[]) => any,
        args?: any[]
    ) => any;
}
...
type VMAssociable = HostNode | BaseLightningElement;
...
function setHook(cmp: BaseLightningElement, prop: PropertyKey, newValue: any) {
    (cmp as any)[prop] = newValue;
}

function getHook(cmp: BaseLightningElement, prop: PropertyKey): any {
