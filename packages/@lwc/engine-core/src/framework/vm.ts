...
export interface VM<N = HostNode, E = HostElement> {
    ...
    /** Actual listeners added to elements corresponding to listeners provided by lwc:on */
    actualEventListeners: WeakMap<Element, Record<string, EventListener>>;
...
export function createVM<HostNode, HostElement>(
    ...
    const vm: VM = {
        ...
        owner,
        refVNodes: null,
        actualEventListeners: new WeakMap(),
        children: EmptyArray,
