...
function allocateInSlot(vm: VM, children: Readonly<VNodes>) {
...
function hasDynamicChildren(children: Readonly<VNodes>): boolean {
...
function updateDynamicChildren(parentElm: Node, oldCh: Readonly<VNodes>, newCh: Readonly<VNodes>) {
    let oldStartIdx = 0;
    let newStartIdx = 0;
...
function updateStaticChildren(parentElm: Node, oldCh: Readonly<VNodes>, newCh: Readonly<VNodes>) {
