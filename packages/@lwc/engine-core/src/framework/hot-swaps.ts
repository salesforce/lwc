...
function rehydrateHotComponent(Ctor: BasicLightningElementConstructor): boolean {
...
export function getComponentOrSwappedComponent(
    ...
    if (featureFlags.ENABLE_HMR) {
        const visited: Set<BasicLightningElementConstructor> = new Set();
...
export function swapComponent(
    oldComponent: BasicLightningElementConstructor,
    newComponent: BasicLightningElementConstructor
): boolean {
    if (process.env.NODE_ENV !== 'production') {
