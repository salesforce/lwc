...
const signedDecoratorToMetaMap: Map<BasicLightningElementConstructor, DecoratorMeta> = new Map();
...
function setDecoratorsMeta(Ctor: BasicLightningElementConstructor, meta: DecoratorMeta) {
...
export function getDecoratorsMeta(Ctor: BasicLightningElementConstructor): DecoratorMeta {
