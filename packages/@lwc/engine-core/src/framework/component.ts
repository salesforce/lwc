...
const signedTemplateMap: Map<BaseLightningElementConstructor, Template> = new Map();
...
export function createComponent(vm: VM, Ctor: BaseLightningElementConstructor) {
