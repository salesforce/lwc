...
const BASE_CONFIG = {
    ...
    namespace: "x",
    files: {
        "node_env.js": readFixture(
            "./node_env/node_env.js"
        ),
        "node_env.html": readFixture(
            "./node_env/node_env.html"
        )
    },
};
...
describe('test shape of the bundle in different modes and environments', () => {
    ...
    test('test minified bundles to remove comments', async () => {
        const minifiedConfig = {
            name: "comments",
            files: {
                "comments.js": readFixture(
                    "./comments/comments.js"
                ),
                "comments.html": readFixture(
                    "./comments/comments.html"
                ),
                "comments.css": readFixture(
