...
it('babel decorator trasofrm', async () => {
    const actual = `
    ...
    expect(code).toMatchInlineSnapshot(`
        ...
        import { registerComponent as _registerComponent, LightningElement, track } from "lwc";
        var _init_foo;
        ...
        class Foo extends LightningElement {
          constructor(...args) {
            super(...args);
            this.foo = _init_foo(this, {});
          }
          /*LWC compiler v2.29.0*/
        }
        [_init_foo] = _applyDecs(Foo, [[track, 0, "foo"]], []);
