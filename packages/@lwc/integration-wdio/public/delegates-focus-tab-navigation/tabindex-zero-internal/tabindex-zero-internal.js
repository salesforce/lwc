(function (lwc) {
    ...
    tmpl.stylesheets = [];
    tmpl.stylesheetToken = "lwc-rimb1s3hmk";
    tmpl.legacyStylesheetToken = "integration-tabindex-zero-internal_tabindex-zero-internal";
    ...
    const __lwc_component_class_internal = lwc.registerComponent(Container, {
      tmpl: _tmpl,
      sel: "integration-tabindex-zero-internal",
      apiVersion: 66
    });

    var element = lwc.createElement('integration-tabindex-zero-internal', {
