(function (lwc) {
    ...
    const $fragment2 = lwc.parseFragment`<span tabindex="0"${3}>Focusable span</span>`;
    const stc0 = {
      props: {
        "tabIndex": "-1"
      },
    ...
    tmpl.stylesheets = [];
    tmpl.stylesheetToken = "lwc-70u157ali1g";
    tmpl.legacyStylesheetToken = "integration-focusable-span-after-negative-tabindex_focusable-span-after-negative-tabindex";
    ...
    const __lwc_component_class_internal = lwc.registerComponent(Container, {
      tmpl: _tmpl,
      sel: "integration-focusable-span-after-negative-tabindex",
      apiVersion: 66
    });

    var element = lwc.createElement('integration-focusable-span-after-negative-tabindex', {
