(function (lwc) {
    ...
    tmpl.stylesheets = [];
    tmpl.stylesheetToken = "lwc-53ekua2qjpl";
    tmpl.legacyStylesheetToken = "integration-tabindex-negative-internal_tabindex-negative-internal";
    ...
    const __lwc_component_class_internal = lwc.registerComponent(Container, {
      tmpl: _tmpl,
      sel: "integration-tabindex-negative-internal",
      apiVersion: 66
    });

    var element = lwc.createElement('integration-tabindex-negative-internal', {
