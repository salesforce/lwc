(function (lwc) {
    ...
    tmpl.stylesheets = [];
    tmpl.stylesheetToken = "lwc-4tspscfl4eg";
    tmpl.legacyStylesheetToken = "integration-tabindex-none_tabindex-none";
    ...
    const __lwc_component_class_internal = lwc.registerComponent(Container, {
      tmpl: _tmpl,
      sel: "integration-tabindex-none",
      apiVersion: 66
    });

    var element = lwc.createElement('integration-tabindex-none', {
