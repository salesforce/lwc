(function (lwc) {
    ...
    const $fragment1 = lwc.parseFragment`<input class="first${0}"${2}>`;
    const $fragment2 = lwc.parseFragment`<input class="second${0}"${2}>`;
    const $fragment3 = lwc.parseFragment`<button disabled${3}>Disabled button</button>`;
    const stc0 = {
      props: {
        "tabIndex": "-1"
      },
    ...
    tmpl.stylesheets = [];
    tmpl.stylesheetToken = "lwc-1335fqsnllt";
    tmpl.legacyStylesheetToken = "integration-disabled-button-after-negative-tabindex_disabled-button-after-negative-tabindex";
    ...
    const __lwc_component_class_internal = lwc.registerComponent(DelegatesFocus, {
      tmpl: _tmpl,
      sel: "integration-disabled-button-after-negative-tabindex",
      apiVersion: 66
    });

    var element = lwc.createElement('integration-disabled-button-after-negative-tabindex', {
