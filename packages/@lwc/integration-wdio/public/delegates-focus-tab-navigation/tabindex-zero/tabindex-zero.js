(function (lwc) {
    ...
    tmpl.stylesheets = [];
    tmpl.stylesheetToken = "lwc-39isup1a9rt";
    tmpl.legacyStylesheetToken = "integration-tabindex-zero_tabindex-zero";
    ...
    const __lwc_component_class_internal = lwc.registerComponent(Container, {
      tmpl: _tmpl,
      sel: "integration-tabindex-zero",
      apiVersion: 66
    });

    var element = lwc.createElement('integration-tabindex-zero', {
