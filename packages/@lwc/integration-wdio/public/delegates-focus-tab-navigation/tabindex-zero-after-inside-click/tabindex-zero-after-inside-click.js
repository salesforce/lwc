(function (lwc) {
    ...
    tmpl.stylesheets = [];
    tmpl.stylesheetToken = "lwc-r0983f6j3g";
    tmpl.legacyStylesheetToken = "integration-tabindex-zero-after-inside-click_tabindex-zero-after-inside-click";
    ...
    const __lwc_component_class_internal = lwc.registerComponent(Container, {
      tmpl: _tmpl,
      sel: "integration-tabindex-zero-after-inside-click",
      apiVersion: 66
    });

    var element = lwc.createElement('integration-tabindex-zero-after-inside-click', {
