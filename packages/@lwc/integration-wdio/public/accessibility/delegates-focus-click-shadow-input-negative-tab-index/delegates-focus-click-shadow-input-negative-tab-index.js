(function (lwc) {
    ...
    const $fragment1$1 = lwc.parseFragment`<input class="negative-tabindex-input${0}" type="text" tabindex="-1"${2}>`;
    const $fragment2$1 = lwc.parseFragment`<span tabindex="0"${3}>Span</span>`;
    function tmpl$1($api, $cmp, $slotset, $ctx) {
      const {st: api_static_fragment} = $api;
      return [api_static_fragment($fragment1$1, 1), api_static_fragment($fragment2$1, 3)];
    ...
    const $fragment1 = lwc.parseFragment`<div tabindex="0" class="selectable-div${0}"${2}>Selectable div</div>`;
    const $fragment2 = lwc.parseFragment`<a href="#"${3}>Anchor</a>`;
    const stc0 = {
      props: {
        "tabIndex": "-1"
      },
    ...
    tmpl.stylesheets = [];
    tmpl.stylesheetToken = "lwc-2d71n4p58ie";
    tmpl.legacyStylesheetToken = "integration-delegates-focus-click-shadow-input-negative-tab-index_delegates-focus-click-shadow-input-negative-tab-index";
    ...
    const __lwc_component_class_internal = lwc.registerComponent(DelegatesFocus, {
      tmpl: _tmpl,
      sel: "integration-delegates-focus-click-shadow-input-negative-tab-index",
      apiVersion: 66
    });
