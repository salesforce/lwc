(function (lwc) {
    ...
    tmpl.stylesheets = [];
    tmpl.stylesheetToken = "lwc-ab6gi2itoi";
    tmpl.legacyStylesheetToken = "integration-tab-navigation-tabindex-zero_tab-navigation-tabindex-zero";
    ...
    const __lwc_component_class_internal = lwc.registerComponent(Container, {
      tmpl: _tmpl,
      sel: "integration-tab-navigation-tabindex-zero",
      apiVersion: 66
    });

    var element = lwc.createElement('integration-tab-navigation-tabindex-zero', {
