(function (lwc) {
    ...
    const $fragment1$1 = lwc.parseFragment`<span tabindex="0"${3}>Focusable span</span>`;
    ...
    let DelegatesFocus$1 = class DelegatesFocus extends lwc.LightningElement {
      /*LWC compiler v8.24.0*/
    };
    const __lwc_component_class_internal$1 = lwc.registerComponent(DelegatesFocus$1, {
      tmpl: _tmpl$1,
    ...
    tmpl.stylesheets = [];
    tmpl.stylesheetToken = "lwc-2cmdmrd2fc8";
    tmpl.legacyStylesheetToken = "integration-delegates-focus-false_delegates-focus-false";
    ...
    var element = lwc.createElement('integration-delegates-focus-false', {
