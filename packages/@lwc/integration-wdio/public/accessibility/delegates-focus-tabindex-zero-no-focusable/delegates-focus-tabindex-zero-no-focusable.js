(function (lwc) {
    ...
    tmpl.stylesheets = [];
    tmpl.stylesheetToken = "lwc-319bt23paf2";
    tmpl.legacyStylesheetToken = "integration-delegates-focus-tabindex-zero-no-focusable_delegates-focus-tabindex-zero-no-focusable";
    ...
    const __lwc_component_class_internal = lwc.registerComponent(Parent, {
      tmpl: _tmpl,
      sel: "integration-delegates-focus-tabindex-zero-no-focusable",
      apiVersion: 66
    });

    var element = lwc.createElement('integration-delegates-focus-tabindex-zero-no-focusable', {
