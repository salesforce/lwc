(function (lwc) {
    ...
    const $fragment1$1 = lwc.parseFragment`<span tabindex="0"${3}>Inside child</span>`;
    const $fragment2$1 = lwc.parseFragment`<input type="text"${3}>`;
    const $fragment3 = lwc.parseFragment`<span tabindex="0"${3}>Inside child</span>`;
    ...
    const $fragment1 = lwc.parseFragment`<a href="#"${3}>First Anchor</a>`;
    const $fragment2 = lwc.parseFragment`<a href="#"${3}>Second Anchor</a>`;
    const stc0 = {
      props: {
        "tabIndex": "-1"
      },
    ...
    tmpl.stylesheets = [];
    tmpl.stylesheetToken = "lwc-36hseqtarl7";
    tmpl.legacyStylesheetToken = "integration-delegates-focus-false-negative-tab-index_delegates-focus-false-negative-tab-index";
    ...
    const __lwc_component_class_internal = lwc.registerComponent(DelegatesFocus, {
      tmpl: _tmpl,
      sel: "integration-delegates-focus-false-negative-tab-index",
      apiVersion: 66
    });

    var element = lwc.createElement('integration-delegates-focus-false-negative-tab-index', {
