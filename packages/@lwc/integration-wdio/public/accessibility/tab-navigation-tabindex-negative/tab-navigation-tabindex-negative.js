(function (lwc) {
    ...
    function tmpl($api, $cmp, $slotset, $ctx) {
      ...
      return [api_static_fragment($fragment1, 1), api_static_fragment($fragment2, 3), api_element("div", stc0, [api_custom_element("integration-child", __lwc_component_class_internal$1, stc1)]), api_static_fragment($fragment3, 7), api_static_fragment($fragment4, 9)];
      /*LWC compiler v8.24.0*/
    }
    var _tmpl = lwc.registerTemplate(tmpl);
    tmpl.stylesheets = [];
    tmpl.stylesheetToken = "lwc-48igkocse3n";
    tmpl.legacyStylesheetToken = "integration-tab-navigation-tabindex-negative_tab-navigation-tabindex-negative";
    ...
    const __lwc_component_class_internal = lwc.registerComponent(Container, {
      tmpl: _tmpl,
      sel: "integration-tab-navigation-tabindex-negative",
      apiVersion: 66
    });

    var element = lwc.createElement('integration-tab-navigation-tabindex-negative', {
