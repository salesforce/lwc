(function (lwc) {
    ...
    tmpl.stylesheets = [];
    tmpl.stylesheetToken = "lwc-41fqld69nk2";
    tmpl.legacyStylesheetToken = "integration-delegates-focus-click-input-in-negative-tabindex_delegates-focus-click-input-in-negative-tabindex";
    ...
    const __lwc_component_class_internal = lwc.registerComponent(DelegatesFocus, {
      tmpl: _tmpl,
      sel: "integration-delegates-focus-click-input-in-negative-tabindex",
      apiVersion: 66
    });

    var element = lwc.createElement('integration-delegates-focus-click-input-in-negative-tabindex', {
