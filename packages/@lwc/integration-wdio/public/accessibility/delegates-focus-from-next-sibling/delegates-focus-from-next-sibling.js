(function (lwc) {
    ...
    const $fragment1$1 = lwc.parseFragment`<input type="range" tabindex="-1"${3}>`;
    ...
    tmpl.stylesheets = [];
    tmpl.stylesheetToken = "lwc-4fpk52buurb";
    tmpl.legacyStylesheetToken = "integration-delegates-focus-from-next-sibling_delegates-focus-from-next-sibling";
    ...
    const __lwc_component_class_internal = lwc.registerComponent(DelegatesFocus, {
      tmpl: _tmpl,
      sel: "integration-delegates-focus-from-next-sibling",
      apiVersion: 66
    });

    var element = lwc.createElement('integration-delegates-focus-from-next-sibling', {
