(function (lwc) {
    ...
    const $fragment1$1 = lwc.parseFragment`<span class="related-target-tagname${0}"${2}>${"t1"}</span>`;
    ...
    function tmpl$1($api, $cmp, $slotset, $ctx) {
      ...
      const {_m0, _m1} = $ctx;
      return [api_static_fragment($fragment1$1, 1, [api_static_part(1, null, api_dynamic_text($cmp.relatedTargetTagname))]), api_static_fragment($fragment2, 3, [api_static_part(0, {
        on: _m1 || ($ctx._m1 = {
          "focusin": api_bind($cmp.handleFocusIn)
        })
      }, null)]), api_static_fragment($fragment3, 5), api_slot("", stc0$1, stc1, $slotset)];
    ...
    const $fragment1 = lwc.parseFragment`<input class="slotted-input${0}" type="text"${2}>`;
    const stc0 = {
      key: 0
    };
    function tmpl($api, $cmp, $slotset, $ctx) {
      const {st: api_static_fragment, c: api_custom_element} = $api;
      return [api_custom_element("integration-parent", __lwc_component_class_internal$1, stc0, [api_static_fragment($fragment1, 2)])];
      /*LWC compiler v8.24.0*/
    }
    var _tmpl = lwc.registerTemplate(tmpl);
    tmpl.stylesheets = [];
    tmpl.stylesheetToken = "lwc-47lco3ia2l1";
    tmpl.legacyStylesheetToken = "integration-retarget-slotted-input-related-target_retarget-slotted-input-related-target";
    ...
    const __lwc_component_class_internal = lwc.registerComponent(RetargetRelatedTarget, {
      tmpl: _tmpl,
      sel: "integration-retarget-slotted-input-related-target",
      apiVersion: 66
    });
