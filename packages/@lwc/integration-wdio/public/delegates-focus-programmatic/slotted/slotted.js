(function (lwc) {
    ...
    function tmpl$1($api, $cmp, $slotset, $ctx) {
      ...
      return [api_slot("", stc0$1, stc1, $slotset), api_static_fragment($fragment1$1, 2)];
    ...
    const $fragment2 = lwc.parseFragment`<input class="slotted-input${0}" placeholder="slotted-input"${2}>`;
    const $fragment3 = lwc.parseFragment`<input class="last${0}" placeholder="last"${2}>`;
    const stc0 = {
      props: {
        "tabIndex": "0"
      },
    ...
    function tmpl($api, $cmp, $slotset, $ctx) {
      ...
      return [api_static_fragment($fragment1, 1), api_custom_element("integration-child", __lwc_component_class_internal$1, stc0, [api_static_fragment($fragment2, 4)]), api_static_fragment($fragment3, 6)];
      /*LWC compiler v8.24.0*/
    }
    var _tmpl = lwc.registerTemplate(tmpl);
    tmpl.stylesheets = [];
    tmpl.stylesheetToken = "lwc-4j8kkpfuc6u";
    tmpl.legacyStylesheetToken = "integration-slotted_slotted";
    ...
    const __lwc_component_class_internal = lwc.registerComponent(Container, {
      tmpl: _tmpl,
      sel: "integration-slotted",
      apiVersion: 66
    });

    var element = lwc.createElement('integration-slotted', {
