(function (lwc) {
    ...
    tmpl.stylesheets = [];
    tmpl.stylesheetToken = "lwc-5ttb5qkjpad";
    tmpl.legacyStylesheetToken = "integration-backwards-compatible_backwards-compatible";
    ...
    const __lwc_component_class_internal = lwc.registerComponent(Container, {
      tmpl: _tmpl,
      sel: "integration-backwards-compatible",
      apiVersion: 66
    });
