...
function stylesheet(token, useActualHostSelector, useNativeDirPseudoclass) {
  ...
  return "@keyframes spin" + suffixToken + " {0% {transform: rotate(0deg);}100% {transform: rotate(360deg);}}.spin" + shadowSelector + " {animation: 1s linear infinite spin" + suffixToken + ";}";
  /*LWC compiler v8.1.0*/
}
