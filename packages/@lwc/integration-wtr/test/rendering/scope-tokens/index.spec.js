...
describe('scope tokens', () => {
    ...
    // Pre-59 API versions render the "legacy" token format (e.g. `x-light_light`); 59+ render the
    // modern lowercase-hash format (e.g. `lwc-1kadf5igpar`). This is a compiler/API-version concern,
    // not a runtime flag.
    ...
    it('light dom', async () => {
        ...
        const verify = () => {
            ...
            expect(getClasses(staticDiv)).toEqual(expectTokens('lwc-1kadf5igpar', 'x-light_light'));
