...
function іşΟрţımɩżаЬḷёΥıёӏḋ(ѕţṁt: EsStatement | undefined): ѕţṁt is OptimizableYield {
    return (
 ...
 * @param node
 */
export function isLiteral(ṅоɗė: IrLiteral | IrExpression | IrComplexExpression): ṅоɗė is IrLiteral {
