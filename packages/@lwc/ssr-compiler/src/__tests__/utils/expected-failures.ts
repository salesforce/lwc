...
export const expectedFailures = new Set([
    ...
    'adjacent-text-nodes/with-comments/preserve-comments/index.js',
    ...
    'comments-text-preserve/index.js',
    ...
    'scoped-slots/undefined-var-name-in-child-and-scoped-slot/index.js',
