import _implicitStylesheets from "./handler-memoization-scopes.css";
import _implicitScopedStylesheets from "./handler-memoization-scopes.scoped.css?scoped=true";
...
tmpl.stylesheets = [];
tmpl.stylesheetToken = "lwc-bqhqvlnsvr";
tmpl.legacyStylesheetToken =
  "x-handler-memoization-scopes_handler-memoization-scopes";
