...
const shadowRootGetter: (this: Element) => ShadowRoot | null = getOwnPropertyDescriptor(
    Element.prototype,
    'shadowRoot'
)!.get!;

const assignedSlotGetter: (this: Element) => HTMLSlotElement | null = getOwnPropertyDescriptor(
    Element.prototype,
    'assignedSlot'
)!.get!;
