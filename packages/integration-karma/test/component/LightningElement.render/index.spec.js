...
it(`throws an error if returns an invalid template`, () => {
    ...
    invalidTemplate.version = process.env.COMPILER_VERSION_NUMBER;
...
it(`throws an error if the returned compiled template has a mismatched version number`, () => {
    // Emulating an invalid template generated by the LWC compiler.
    const invalidTemplate = () => [];
    invalidTemplate.version = 123456789;
    registerTemplate(invalidTemplate);
    ...
    expect(() => {
        ...
        Error,
        /Assert Violation: Mismatch between compiled template version and runtime engine version. Current engine is v2, but <x-dynamic-template> was compiled with v123456789\./
    );
});
