...
Test.publicProps = {
  publicGetter: {
    ...
    pluginTest(
        'transforms public getter/setter',
        `
        import { api } from 'engine';
        export default class Test {
            @api get something() {
...
Test.publicProps = {
  something: {
    ...
    pluginTest(
        'throws error if setter is not associated with a getter',
        `
        import { api } from 'engine';
        export default class Test {
    ...
    `,
        {
            error: {
                message:
                    'test.js: @api set publicSetter setter does not have associated getter.',
                loc: {
                    line: 2,
                    column: 9,
                },
    ...
    `,
        {
            error: {
                message:
                    'test.js: Boolean public property must default to false.',
                loc: {
                    line: 2,
                    column: 9,
                },
    ...
    `,
        {
            error: {
                message:
                    'test.js: Invalid property name is. "is" is a reserved attribute.',
                loc: {
                    line: 2,
                    column: 9,
                },
    ...
    `,
        {
            error: {
                message:
                    'test.js: Invalid property name onChangeHandler. Properties starting with "on" are reserved for event handlers.',
                loc: {
                    line: 2,
                    column: 9,
                },
...
Test.publicProps = {
  data: {
    ...
    `,
        {
            error: {
                message:
                    'test.js: Invalid property name dataFooBar. Properties starting with "data" are reserved attributes.',
                loc: {
                    line: 2,
                    column: 9,
                },
    ...
    pluginTest(
        'throws error if property name prefixed with "aria"',
        `
        import { api } from 'engine';
        export default class Test {
            @api ariaDescribedby;
    ...
    `,
        {
            error: {
                message:
                    'test.js: Invalid property name ariaDescribedby. Properties starting with "aria" are reserved attributes.',
                loc: {
                    line: 2,
                    column: 9,
                },
    ...
    pluginTest(
        'throws error if property name conflicts with global html attribute name',
        `
        import { api } from 'engine';
        export default class Test {
            @api slot;
    ...
    `,
        {
            error: {
                message:
                    'test.js: Invalid property name slot. slot is a global HTML attribute, use attributeChangedCallback to observe this attribute.',
                loc: {
                    line: 2,
                    column: 9,
                },
    ...
    `,
        {
            error: {
                message:
                    'test.js: Invalid property name part. "part" is a future reserved attribute for web components.',
                loc: {
                    line: 2,
                    column: 9,
                },
    ...
    `,
        {
            error: {
                message:
                    'test.js: @api method or property cannot be used with @track',
                loc: {
                    line: 2,
                    column: 20,
                },
    ...
    `,
        {
            error: {
                message:
                    'test.js: @api cannot be applied to a computed property, getter, setter or method.',
                loc: {
                    line: 2,
                    column: 9,
                },
