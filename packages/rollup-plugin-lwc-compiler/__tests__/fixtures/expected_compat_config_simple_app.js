...
(function (engine) {
    ...
    if (style$1) {
      __setKey$3(tmpl, "token", 'x-foo_foo');
      ...
      __setKey$3(style$2, "textContent", style$1('x-foo', 'x-foo_foo'));
    ...
    function (_Element) {
      ...
      function Foo() {
        ...
        return _possibleConstructorReturn(_this, (_temp = _this = _possibleConstructorReturn(this, __callKey2(__getKey$4(_getPrototypeOf2 = _getPrototypeOf(Foo), "call"), "apply", _getPrototypeOf2, __concat([this], args))), __setKey$4(_this, "x", void 0), _temp));
      }
    ...
    if (style) {
      __setKey$5(tmpl$1, "token", 'x-app_app');
      ...
      __setKey$5(style$3, "textContent", style('x-app', 'x-app_app'));
