...
describe('transform', () => {
    ...
    // TODO: Seems like style injection doesn't default to 'c-' if namespace is not provided,
    // will be handling this separately.
    //
    ...
    //         const style = document.createElement('style');
    //         style.type = 'text/css';
    //         style.dataset.token = 'undefined-foo_foo'
