 ...
 * The @wire service.
 *
 * Provides data binding between services and raptor modules decorated with @wire.
 * This service is Salesforce-agnostic. The data-providing services must be provided
 * to this module.
 */

import { WiredValue } from './wired-value';
import { buildWireAdapterMap } from './wire-adapters';
 ...
 */
export function getPropToParams(wireDef, wireTarget) {
 ...
 */
export function getStaticConfig(wireDef) {
 ...
 */
export function getIsMethod(wireDef) {
 ...
 */
export function getWireConfigs(def) {
 ...
 */
export function installWiring(cmp, def) {
